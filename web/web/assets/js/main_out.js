(function() {
    ...
    function drawGame() {
        ...
        if (!isNaN(stats.score)) {
            document.getElementById("dqnScore").value = stats.score.toString()
    ...
    function init() {
        ...
        setInterval(function() {
            ...
            var typeControl = document.getElementById("dqnMovementType").value;
            if (typeControl === "1"){
                mouseX = parseInt(document.getElementById("dqnMouseX").value);
                mouseY = parseInt(document.getElementById("dqnMouseY").value);
            }
